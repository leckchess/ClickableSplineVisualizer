...
#include "ClickableHISMVisualizerEditorMode.generated.h"
 ...
 */
UCLASS()
class UClickableHISMVisualizerEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_ClickableHISMVisualizerEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UClickableHISMVisualizerEditorMode();
	virtual ~UClickableHISMVisualizerEditorMode();
