...
#include "ClickableHISMVisualizerInteractiveTool.generated.h"


/**
 * Builder for UClickableHISMVisualizerInteractiveTool
 */
UCLASS()
class CLICKABLEHISMVISUALIZER_API UClickableHISMVisualizerInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UClickableHISMVisualizerInteractiveTool
 */
UCLASS(Transient)
class CLICKABLEHISMVISUALIZER_API UClickableHISMVisualizerInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UClickableHISMVisualizerInteractiveToolProperties();
...
/**
 * UClickableHISMVisualizerInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class CLICKABLEHISMVISUALIZER_API UClickableHISMVisualizerInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UClickableHISMVisualizerInteractiveToolProperties> Properties;
